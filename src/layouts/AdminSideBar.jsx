...
export function AdminSideBar({ children }) {
  ...
  const navLinks = [
    ...
    { icon: Building, label: "Track Manager", to: "/" },
    { icon: Briefcase, label: "Job Manager", to: "/" },
    { icon: FileText, label: "Exam Manager ", to: "/" },
    { icon: CheckSquare, label: "Registration Requests", to: "/" },
    { icon: Users, label: "Companies", to: "/" },
    { icon: Users, label: "Company Profile", to: "/" },
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-white bg-opacity-80 border-b border-gray-200 py-4 px-6 flex w-full justify-between items-center lg:pl-72 fixed backdrop-blur-sm z-30">
        <h1 className="text-xl font-medium">Track Manager</h1>
      ...
      <div className="flex flex-1 pt-16">
        ...
        <aside className="hidden lg:flex w-60 bg-white border-r border-gray-200 flex-col fixed top-0 left-0 h-full z-40 ">
          <div className="p-4 border-b border-gray-200">
            <h1 className="text-blue-600 font-bold text-xl">Fit 4 Job</h1>
          </div>
